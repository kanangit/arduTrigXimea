...
unsigned long long_delay = 300UL; // delay between the first out pulse and and 2nd one
unsigned long reg_delay = 200UL; // delay between the "regular pulses"
unsigned long n_pulses = 2000;
//double fps = 400;
